...
/**
 * Zoho Mail helper for Agent 4 — the daily checkpoint, weekly report, SLA
 * breach alerts, and content compliance alerts all send via the Zoho Mail API
 * (design doc §1: ZohoMail.messages.CREATE).
 *
...
const DEFAULT_FROM = 'compliance@gracelyn.edu';
...
async function getAccountId() {
  ...
  const fromAddr = M.getEnv('AGENT4_MAIL_FROM_ADDRESS') || DEFAULT_FROM;
