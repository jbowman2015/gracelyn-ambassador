...
/**
 * Zoho WorkDrive helper for Agent 4 — read-only.
 *
 * Agent 4 only reads ambassador_copy_rules.txt from Folder 08 for the weekly
 * content compliance audit (design §2.2, §7 Scenario 5). No WorkDrive writes
 * are required by the design doc.
 *
 * OAuth uses the ZOHO_WORKDRIVE trio. No SDK dependency: raw https. All calls
