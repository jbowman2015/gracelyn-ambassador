...
/**
 * Zoho CRM helper for Agent 4 — metadata + records.
 *
 * Same metadata-helper pattern as functions/agent5A/zoho.js and
 * functions/agent0/zoho.js (token refresh + crmGet + fetchModules/fetchFields),
 * plus the record operations Agent 4 needs: paged reads across Ambassadors /
 * Referrals / Support_Tickets for the daily jobs, and single-record updates for
 * writing SLA_Breached / Resolution_SLA_Breached.
 *
 ...
 * `verifyFields` cross-checks the field names Agent 4 depends on against Zoho's
