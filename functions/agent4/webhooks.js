...
/**
 * Make.com webhook delivery for Agent 4 (design §7 Scenarios 4 + 5).
 *
 * Thin POST helper with the same one-retry policy as functions/agent0/webhooks.js
 * and functions/agent3/webhooks.js. Returns a result object rather than
 * throwing so callers can apply per-scenario fallbacks (design §8).
 */
 ...
 *
 * `deps.postJson` is injectable for tests.
 */
