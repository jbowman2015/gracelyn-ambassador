...
/**
 * Make.com webhook delivery for Agent 1D (design §7, §8). Thin POST helper
 * with the design's one-retry policy. Returns a result object rather than
 * throwing so the caller can apply per-scenario fallbacks.
 */
