...
/**
 * Make.com webhook delivery for Agent 0 (design §8).
 *
 * Thin POST helper with the design's one-retry policy. Returns a result object
 * rather than throwing so the pipeline can apply per-scenario fallbacks (§9).
 */
