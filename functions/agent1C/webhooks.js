...
/**
 * Make.com webhook delivery for Agent 1C (design §6). Same one-retry pattern
 * as functions/agent0/webhooks.js: returns a result object rather than
 * throwing so the pipeline can apply its own per-scenario fallback (§7).
 */
