...
/**
 * Zoho Mail client for Agent 5 — used only for the fallback escalation email
 * (design §1, §9 Make.com error path, §10) when the Make.com escalation webhook
 * fails twice. No SDK dependency: raw https to the Zoho Mail REST API
 * (POST /api/accounts/{accountId}/messages), same pattern as functions/agent2/mail.js.
 */
...
/** Send a plain-text email. Throws on failure — callers apply the design's alert policy. */
