...
/**
 * Zoho Mail helper for Agent 6 — buffer alert emails only (design §1, §6).
 * Reuses the OAuth + send pattern from functions/agent3/mail.js.
 */
...
/**
 * Send an email. Returns { ok, status, error }. Never throws — the buffer
 * job logs + surfaces failures rather than crashing the daily run.
 */
